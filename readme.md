...
*(Reemplazar o añadir aquí abajo la captura de pantalla de la página funcionando en el navegador en la que se vean los componentes:* `![Captura](ruta-de-la-imagen.png)`*)*
